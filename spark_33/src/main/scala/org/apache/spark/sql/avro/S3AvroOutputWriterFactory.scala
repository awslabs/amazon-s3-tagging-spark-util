...
private[avro] class S3AvroOutputWriterFactory(catalystSchema: StructType,
                                              ...
                                              tagString: String)
  extends AvroOutputWriterFactory(catalystSchema, avroSchemaAsJsonString, positionalFieldMatching) {
  ...
  override def newInstance(path: String,
    ...
    new S3AvroOutputWriter(path, tags, context, catalystSchema, positionalFieldMatching, avroSchema)
  }
}
